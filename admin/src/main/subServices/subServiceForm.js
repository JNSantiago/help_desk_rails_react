...
class SubServiceForm extends Component {
    render() {
        ...
        return (
            <form className="form-horizontal" role="form" onSubmit={ handleSubmit }>
                ...
                <div className="form-group row">
                    <label className="col-2 col-form-label">Service id</label>
                    <div className="col-10">
                        <Field type="text" className="form-control" component="input" name="service_id" />
                    </div>
                </div>
...
export default reduxForm({form: 'subServiceForm'})(SubServiceForm)